...
public class Utility {
    ...
    public static List<FollowableUser> createSampleFollowableUserList() {
        ...
        followableUsers.add(new FollowableUser("1", "Joelia", "Agbavon",
                true, "Mar 07, 2024, 10:54 PM"));
        followableUsers.add(new FollowableUser("2", "Susan", "Awad",
                false, "Mar 05, 2024, 11:00 AM"));
        followableUsers.add(new FollowableUser("3", "My", "Ly",
